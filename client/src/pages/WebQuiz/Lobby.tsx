...
import { Play, Plus, Users, BrainCircuit, Zap, Loader2, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4 md:space-y-6">
      <div className="flex items-center mb-2">
         <Link to="/" className="inline-flex items-center gap-2 text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-white transition-colors font-semibold bg-slate-200/50 dark:bg-surface px-4 py-2 rounded-lg">
           <ArrowLeft size={18} /> <span className="hidden sm:inline">Về Trang Chủ (Vibe Portal)</span>
         </Link>
      </div>

      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl p-6 md:p-8 text-white shadow-xl relative overflow-hidden">
