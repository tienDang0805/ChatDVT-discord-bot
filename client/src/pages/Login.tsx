...
export const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden font-mono">
      ...
      <div className="w-full max-w-md bg-slate-900/80 border border-emerald-500/30 rounded-2xl p-8 shadow-sm relative z-10">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          {error && (
            <div className="flex items-center gap-2 text-red-400 text-xs bg-red-400/10 p-3 rounded border border-red-400/20">
              <AlertCircle size={16} />
              {error}
            </div>
          )}
